...
```text
ADR-000X: Genome Is Primary Hereditary Carrier
ADR-000X: Non-genome State Can Be Secondarily Hereditary
ADR-000X: Learning-like State Is Not Genome Heredity
ADR-000X: Species Are Emergent, Not Hardcoded
```
...
Потрібно вирішити, чи stateful material coefficients передаються в MVP.
...
Потрібно визначити мінімальний набір lineage metrics для MVP.
...
Потрібно визначити, чи fragment-based heredity входить у MVP або залишається future model.
