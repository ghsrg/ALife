...
Для MVP можна використовувати простий random subgraph або predefined fragment container.
...
Але MVP не повинен залежати від складного matching.
...
Для MVP краще або не використовувати tags, або використовувати їх лише для технічного групування, а не поведінки.
...
У MVP recombination можна не реалізовувати фізично, але принцип вартості треба зберегти.
...
Для MVP recombination можна залишити як future model після стабілізації mutation та inheritance.
...
MVP не потребує multi-parent recombination.
...
Для MVP recombination можна не реалізовувати повністю.
...
```text
ADR-000X: Recombination Does Not Require Perfect Graph Alignment
ADR-000X: Fragments as Units of Genome Mixing
ADR-000X: Recombined Genome May Be Non-viable
ADR-000X: No Hardcoded Species Compatibility
```
...
Потрібно вирішити, чи recombination входить у MVP, чи залишається post-MVP.
...
Потрібно вирішити, чи silent fragments можуть зберігатися в MVP.
