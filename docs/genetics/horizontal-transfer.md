...
`Genetic Fragment` є фізичним фрагментом спадкової інформації: має carrier, volume, stability, damage і cost. Він не є абстрактним message і не є Resource за замовчуванням, хоча future implementation може представити external fragments як resource-like packets.
...
Для першої реалізації HGT можна не реалізовувати.
...
Поточне рішення: HGT не входить у першу реалізацію, але документація і модель Genome не повинні блокувати future HGT.

## Fragment object

Потрібно вибрати реалізаційне представлення external genetic fragment:
