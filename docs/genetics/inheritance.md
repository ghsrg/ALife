...
Для базової моделі можна почати з одного Genome на клітину.
...
Для базової моделі фрагменти можна залишити як future-compatible концепцію.
...
Для базової моделі можна використати простий пропорційний розподіл із невеликим шумом.
...
Energy не є речовиною і не транспортується між незалежними клітинами.

Під час поділу локальний стан однієї батьківської клітини partition-иться між дочірніми клітинами.
...
Для базової моделі можна зробити просте правило:
...
# Minimal Inheritance for базова модель

Для базової моделі достатньо моделі:
...
# базова модель Inheritance Algorithm
...
## базова модель inheritance balance
...
Потрібно вирішити, чи Genome fragments існують У базовій моделі, чи лише в future model.
