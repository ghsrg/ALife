...
Не все потрібно реалізовувати у базовій моделі.
...
# базова модель Epigenetics

Для базової моделі можна використати просту модель:
...
# Runtime базової моделі Integration
...
# базова модель Inheritance

Для базової моделі epigenetic inheritance можна зробити простою:
...
## базова модель fields

Потрібно остаточно визначити мінімальний набір полів EpigeneticState Для базової моделі.
...
Потрібно визначити, чи specialization_state входить у базову модель або відкладається до development/organism рівня.
