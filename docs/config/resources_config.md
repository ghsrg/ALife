...
У MVP можна не використовувати.
...
Потрібно вирішити, наскільки складними будуть reactions у MVP.

## Resource phase

Потрібно визначити, чи `phase` впливає на physics у MVP, чи лише на diffusion.
