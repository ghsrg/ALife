...
Зв'язок Materials, Capabilities і allowed process set описаний у `biology/process-capabilities.md`.
...
Ці properties повинні мапитися в Capability-рівень, а не напряму запускати процеси.
...
Обов’язкові поля базова модель:
...
Для early-world базова модель можна почати з 5–6 Materials.
...
У базовій моделі це можна не реалізовувати.
...
## базова модель property set

Потрібно синхронізувати мінімальний набір Material properties з capability matrix у `biology/process-capabilities.md`.

## Stateful Materials

Потрібно вирішити, чи stateful Materials входять у базовій моделі або у майбутньому.

## Movement Materials

Потрібно визначити, чи movement_support входить у базову модель.
