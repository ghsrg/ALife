...
- normalizes values for: [[docs/world/resources|Resources]]
- normalizes values for: [[docs/world/materials|Materials]]
- normalizes values for: [[docs/world/energy|Energy]]
- used by: [[docs/config/stability_bounds|Stability Bounds]]
