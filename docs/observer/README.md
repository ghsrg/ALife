...
3. [[docs/observer/projection-contract|Projection Contract]] — шаблон для майбутніх UI/debug/analytics projection.
4. [[docs/mechanics/observer-projection|Committed State -> Observer Projection]] — коротка pre-flight card для агентів.
