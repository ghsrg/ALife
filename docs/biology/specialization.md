...
Для MVP не потрібно вводити явну систему cell types.
...
MVP може мати просту класифікацію лише для debug UI.
...
```text
ADR-000X: Specialization Is Emergent, Not Hardcoded
ADR-000X: No Cell Classes for Biological Roles
ADR-000X: Tissue-like and Organ-like Structures Are Analytical Patterns
ADR-000X: Observed Roles Must Not Drive Cell Behavior
```
...
## MVP specialization tracking

Потрібно вирішити, чи MVP буде логувати specialization metrics.
...
Потрібно вирішити, чи дозволяти клітинам втрачати здатність до самостійного reproduction у MVP.
