...
Потрібно визначити, які процеси виконуються миттєво в межах Tick, а які накопичують progress.

## Failure modes

Потрібно деталізувати, що саме відбувається при зриві процесу:
