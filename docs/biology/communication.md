...
Для базової моделі основні канали:
...
Для базової моделі достатньо одного або кількох числових сигналів.
...
Для базової моделі delay можна відкласти.
...
# базова модель Communication Model
...
# базова модель Communication Update
...
Потрібно вирішити, чи delay входить у базову модель.
