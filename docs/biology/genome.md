...
У MVP можна почати з одного Genome на клітину.
...
У MVP Genome може бути представлений як регуляторна мережа.
...
# Варіант MVP: Regulatory Network

Базовий варіант для MVP:
...
Для MVP це можна залишити як Research/Future Work.
...
MVP не потребує повної моделі реальної ДНК.
...
```text
ADR-000X: Genome Regulates, It Does Not Execute Work
ADR-000X: Genome Has Physical Carrier
ADR-000X: Direct Regulatory Network as MVP Genome
ADR-000X: Keep Genome Model Compatible with HGT
```
...
## Остаточне представлення Genome

Потрібно вибрати MVP-представлення:
...
Потрібно визначити, чи Genome Runtime витрачає Energy у MVP.
...
Потрібно визначити, чи Genome repair буде в MVP або пізніше.
