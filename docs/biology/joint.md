...
У MVP не потрібно hardcode багато типів Joint.
...
У MVP достатньо спростити його до spring-like моделі.
...
Для MVP достатньо простої моделі:
...
```text
ADR-000X: Joint as Universal Material Cell Connection
ADR-000X: No Direct Energy Buffer Transfer Through Joint
ADR-000X: Organism as Cell-Joint Graph
ADR-000X: Tissues and Organs Are Emergent, Not Hardcoded
```
...
Потрібно вирішити, чи Joint у MVP буде:
...
Потрібно вирішити, чи Joint може передавати genetic fragments у MVP або post-MVP.
