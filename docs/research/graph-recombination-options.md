...
Цей файл не є MVP specification.
...
Для MVP повна graph recombination не є обов'язковою.

MVP має бути сумісним із майбутньою recombination, але не повинен реалізовувати складний graph crossover на старті.
...
Жоден із цих варіантів не є затвердженим для MVP.
...
* блокувати MVP через складну recombination.
...
Не вважати його порожнім або незавершеним MVP-документом.
