...
Цей документ описує базові performance-принципи для першої реалізації.
...
Для MVP можна простіше, але не робити повний deep copy всіх даних без потреби.
...
Для MVP важливіше determinism, ніж parallel performance.
...
basic Resources
basic Fields
basic Genome Runtime
basic mutation/division/death
CPU-only
...
MVP має бути deterministic before parallel.
...
* Який target cell count для MVP?
