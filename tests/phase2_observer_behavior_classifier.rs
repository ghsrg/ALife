use alife::observer::{
    ...
    classifiers::{classify_behavior_profiles, ClassificationStatus},
};
use std::collections::HashMap;

#[test]
fn test_classify_behavior_profiles() {
    let config = load_behavior_profile_classifier("docs/config/observer/behavior-profile-classifier.toml").unwrap();
