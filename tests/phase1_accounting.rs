...
fn cell_store_inserts_one_cell_with_deterministic_id() {
    ...
    let id = cells.insert_initial(InitialCellState {
        ...
        boundary_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        transport_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        metabolic_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        storage_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        synthesis_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        structural_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        repair_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        contractile_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
        sensory_material: MaterialAmount::new(3.0 / 9.0).unwrap(),
